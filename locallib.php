...
//        $mform->addElement('html', $box );
        ...
        {
            $mform->addElement('textarea', 'comments', get_string('comments', 'attendanceregister'),null );
            ...
            /*
            $mform->addElement('editor', 'comments', get_string('comments', 'attendanceregister'));
            $mform->setType('comments', PARAM_TEXT);
            $mform->addRule('comments', get_string('maximumchars', '', 255), 'maxlength', 255, 'client' );
            if ( $register->mandatoryofflinecomm ) {
                $mform->addRule('comments', get_string('required'), 'required', null, 'client');
...
function getTomorrow($datetoday)
{
    $datetomorrow = date('y-m-d', strtotime('+1 day',$datetoday));
    $datetomorrowint = strtotime($datetomorrow);
    return $datetomorrowint;
}
